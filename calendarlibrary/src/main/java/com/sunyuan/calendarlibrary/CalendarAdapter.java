...
import static com.sunyuan.calendarlibrary.MonthView.SELECT_BG_DRAWABLE_FIRST;
import static com.sunyuan.calendarlibrary.MonthView.SELECT_BG_DRAWABLE_LAST;
...
final class CalendarAdapter extends RecyclerView.Adapter<CalendarAdapter.CalendarHolder> implements
    ...
    private void parseTypedArray(Context context, TypedArray typedArray) {
        ...
        Drawable selectBgDrawableFisrt = typedArray.getDrawable(R.styleable.CalendarView_cl_selectBgDrawableFirst);
        Drawable selectBgDrawableLast = typedArray.getDrawable(R.styleable.CalendarView_cl_selectBgDrawableLast);
        ...
        ATTRS.put(SELECT_BG_DRAWABLE_FIRST, selectBgDrawableFisrt);
        ATTRS.put(SELECT_BG_DRAWABLE_LAST, selectBgDrawableLast);
